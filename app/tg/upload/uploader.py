...
from app.tg import compression, partition
...
from app.tg.upload.analytics import _UploadAnalyticsMixin
from app.tg.upload.batch import _SmallBatchMixin
from app.tg.upload.multipart import _MultipartUploadMixin
from app.tg.upload.parallel import _ParallelUploadMixin
from app.tg.upload.records import _UploadRecordBuffer
...
class TgUploader(
    ...
    _FORCE_POOL_MULTIPART_ENV = "GLIDEDRIVE_FORCE_POOL_MULTIPART"
