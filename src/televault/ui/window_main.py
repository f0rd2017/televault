...
from televault.core.i18n import (
    available_languages,
    install_language,
    language_by_code,
    save_language,
...
from televault.core.types import AppConfig, JobEvent
from televault.core.utils import app_icon_path
from televault.core.worker import TelegramWorker
from televault.db.repo import DbRepo
from televault.ui.job_toasts import JobToastCard, JobToastOverlay
from televault.ui.models_qt import ExplorerGridModel, FolderTreeModel
from televault.ui.widgets import ProgressLogWidget
from televault.ui.panels import (
    ExplorerDropFrame,
...
class MainWindow(
    ...
    def _cleanup_thumbnail_dirs_async(self) -> None:
        ...
        def _run() -> None:
            ...
            from televault.core.utils import clear_dir_files, evict_dir_to_limit
    ...
    def reload_items(self) -> None:
        ...
        from televault.ui.models_qt import ExplorerFolderItem, ExplorerFileItem
        ...
        from televault.core.object_state import display_state as _display_state
