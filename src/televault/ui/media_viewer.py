...
class ImageViewerWindow(QWidget):
    ...
    def _decode_via_ffmpeg_async(self, raw: bytes) -> None:
        ...
        def _worker() -> None:
            ...
            from televault.core.utils import convert_image_to_png
...
class VideoViewerWindow(QWidget):
    ...
    def _try_transcode_fallback(self) -> bool:
        ...
        on the fly, see televault.core.transcode). True = playback was restarted."""
        ...
        from televault.core.transcode import transcode_available
