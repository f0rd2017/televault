...
from televault.ui.dialogs._style import _DIALOG_STYLESHEET
...
class FilePropertiesDialog(QDialog):
    ...
    def __init__(
        ...
        *,
        ...
        from televault.core.object_state import classify_object_state
...
class ShareLinkDialog(QDialog):
    ...
    def _on_create(self) -> None:
        ...
        from televault.core.sharing import hash_share_password, new_share_token
        from televault.core.utils import now_ts
