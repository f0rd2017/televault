...
from televault.ui.theme import main_window_stylesheet
...
class MiscMixin:
    ...
    def _on_create_folder(self, parent_folder: str | None = None) -> None:
        from televault.ui.dialogs import CreateFolderDialog
    ...
    def _on_settings(self) -> None:
        from televault.ui.dialogs import SettingsDialog
    ...
    def _on_accounts(self) -> None:
        ...
        from televault.ui.dialogs._accounts import AccountsDialog
    ...
    def _on_show_hotkeys(self) -> None:
        ...
        when either changes."""
        from televault.ui.dialogs._hotkeys import HotkeysDialog
