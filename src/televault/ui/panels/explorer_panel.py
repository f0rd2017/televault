...
from televault.core.types import JobType, ObjectEntry
...
class ExplorerPanelMixin:
    ...
    def _on_rename_file(self, entry: ObjectEntry) -> None:
        ...
        from televault.ui.dialogs import RenameDialog
    ...
    def _on_open_stream(self, entry) -> None:
        ...
        from televault.ui.media_viewer import open_media_viewer
        from televault.ui.models_qt import is_video_name, is_pdf_name
    ...
    def _on_edit_file(self, entry) -> None:
        ...
        from televault.ui.text_editor import _MAX_EDIT_BYTES
        ...
        from televault.ui.text_editor import open_text_editor
