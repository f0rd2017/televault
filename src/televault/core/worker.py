...
from televault.core.jobs import JobContext, JobManager
from televault.core.types import AppConfig, JobEvent, JobStatus, JobType
from televault.core.accounts import AccountManager, ConnectedAccount
from televault.db.repo import DbRepo
from televault.tg.client import TgClientManager
...
class TelegramWorker(QThread):
    ...
    async def _main(self) -> None:
        ...
        if upload_accounts:
            from televault.core.types import TgTransferLimits
        ...
        # tier of the primary→backup→direct chain (see televault.tg.proxy_escalation).
    ...
    async def _run_video_poster(
        ...
        from televault.core.utils import extract_video_poster_png
    ...
    async def _run_blob_manifest_recovery(
        ...
        televault.tg.blob_recovery). No-op when no clients are connected."""
        with self._state_lock:
        ...
        from televault.tg.blob_recovery import recover_blob_manifests
