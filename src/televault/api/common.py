...
class StreamResponse:
    ...
    ``layout`` is a :class:`televault.core.stream.StreamLayout` (plaintext part offsets);
...
class TranscodeResponse:
    ...
    is a chunked stream without Range/seeking support (see televault.core.transcode)."""
