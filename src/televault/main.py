...
from televault.api import ApiServer
...
from televault.core.logging import setup_logging
from televault.core.utils import app_icon_path, ensure_dir, ensure_parent_dir
...
from televault.tg.client import ensure_session_authorized
from televault.ui.theme import apply_theme
from televault.ui.dialogs import SetupDialog
...
def run() -> int:
    ...
    from televault.core.i18n import i18n_dir, install_language, saved_language
