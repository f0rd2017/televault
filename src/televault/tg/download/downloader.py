...
from televault.core.types import AppConfig, PartRecord, TgTransferLimits
...
from televault.tg.download.analytics import _DownloadAnalyticsMixin
from televault.tg.download.batch import _DownloadBatchMixin
from televault.tg.download.fetch import _DownloadFetchMixin
from televault.tg.download.merge import _DownloadMergeMixin
    ...
    async def fetch_parts_decrypted(
        ...
        *,
        ...
        if self.config.crypto.enabled:
            ...
            from televault.core.utils import load_aesgcm_key_from_env
